<?php
namespace Hn\SwBundle\Services\Tool;
...
class Upload
{
    ...
    public function __construct()
    {
        ...
        $this->path = 'Upload';
        //上传类型
        $this->type = explode(',', strtolower('jpg,jpeg,gif,png,zip,rar,doc,txt'));
        //允许大小
    ...
    private function save($file)
    {
        ...
        $arr              = array();
        $arr['path']      = $filePath;
        $arr['url']       = rtrim('http://' . $_SERVER['HTTP_HOST'] . preg_replace('@\w+\.php$@i', '', $_SERVER['SCRIPT_NAME']), '/') . '/' . $filePath;
        $arr['uptime']    = time();
